...
@Service
@Primary // Resolves ambiguity when a single PaymentGateway is requested without qualifier
public class StripePaymentGatewayCorrect implements PaymentGateway {
